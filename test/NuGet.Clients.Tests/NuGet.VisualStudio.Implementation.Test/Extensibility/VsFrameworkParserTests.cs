...
namespace NuGet.VisualStudio.Implementation.Test.Extensibility
{
    public class VsFrameworkParserTests
    {
        ...
        public void TryParse_ValidInput_Succeeds(string input)
        {
            ...
            Assert.Equal(expected.Version, actual.TargetFrameworkVersion);
            Assert.Equal(expected.Profile, actual.Profile);
            Assert.Equal(expected.Platform, actual.TargetPlatformIdentifier);
            Assert.Equal(expected.PlatformVersion, actual.TargetPlatformVersion);
        }
        ...
        public void TryParse_InvalidInput_ReturnsFalse(string input)
        {
            ...
            // Assert
            Assert.False(actual, $"Expected false, but got true for {input}. TFI {parsed.TargetFrameworkIdentifier}, TFV {parsed.TargetFrameworkVersion}, Profile {parsed.Profile}, TPI {parsed.TargetPlatformIdentifier}, TPV {parsed.TargetPlatformVersion}");
        }
    }
}
